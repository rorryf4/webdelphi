...
function statusFromGame(g: AnyRec) {
...
export default function GamesPage() {
  ...
  const analysisMap = React.useMemo(() => {
    ...
    (analysis ?? []).forEach((r) => m.set(resultKey(r), r));
    return m;
  }, [analysis]);
